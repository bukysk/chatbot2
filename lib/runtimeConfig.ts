...
import { CHUNK_SIZE, CHUNK_OVERLAP, MIN_CHUNK_LENGTH, EMBEDDING_MODEL, TOP_K_DEFAULT, CHAT_TEMPERATURE, INCLUDE_SUBJECT_CONTEXT_DEFAULT, CHAT_MODEL, PROMPT_TEMPLATE } from './config';
...
export function getEffectiveConfig() {
  ...
  return {
    ...
    CHAT_MODEL: String(o.CHAT_MODEL ?? CHAT_MODEL),
    ...
    PROMPT_TEMPLATE: String(o.PROMPT_TEMPLATE ?? PROMPT_TEMPLATE),
  };
}
